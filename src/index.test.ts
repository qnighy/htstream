...
describe("tokenize", () => {
  ...
  it("tokenizes open tags with attributes", async () => {
    ...
    ensureTokenization([
      "<div f",
      ["oo=bar>", [{ type: "StartTag", raw: "<div foo=bar>"}]],
      "<div f",
      ["oo=\"bar\">", [{ type: "StartTag", raw: "<div foo=\"bar\">"}]],
      "<div f",
      ["oo='bar'>", [{ type: "StartTag", raw: "<div foo='bar'>"}]],
      "<div f",
      ["oo=bar>foo>", [{ type: "StartTag", raw: "<div foo=bar>"}, { type: "Text", raw: "foo>" }]],
      "<div f",
      ["oo=\"bar>foo\">", [{ type: "StartTag", raw: "<div foo=\"bar>foo\">"}]],
      "<div f",
      ["oo='bar>foo'>", [{ type: "StartTag", raw: "<div foo='bar>foo'>"}]],
      "<div f",
      ["oo = \"bar>foo\">", [{ type: "StartTag", raw: "<div foo = \"bar>foo\">"}]],
      ...
      ["oo = 'bar>foo'>", [{ type: "StartTag", raw: "<div foo = 'bar>foo'>"}]],
      "<div f",
      ["o=o=\"bar>foo\">", [{ type: "StartTag", raw: "<div fo=o=\"bar>"}, { type: "Text", raw: "foo\">" }]],
      "<div f",
      ["o=o='bar>foo'>", [{ type: "StartTag", raw: "<div fo=o='bar>"}, { type: "Text", raw: "foo'>" }]],
      "<div =",
      ["foo=\"bar>foo\">", [{ type: "StartTag", raw: "<div =foo=\"bar>foo\">"}]],
      "<div =",
      ["foo='bar>foo'>", [{ type: "StartTag", raw: "<div =foo='bar>foo'>"}]],
      "<div=== f",
      ["oo=\"bar>foo\">", [{ type: "StartTag", raw: "<div=== foo=\"bar>foo\">"}]],
      ...
      ["oo='bar>foo'>", [{ type: "StartTag", raw: "<div=== foo='bar>foo'>"}]],
      "<div a",
      [" foo=\"bar>foo\">", [{ type: "StartTag", raw: "<div a foo=\"bar>foo\">"}]],
      "<div a",
      [" foo='bar>foo'>", [{ type: "StartTag", raw: "<div a foo='bar>foo'>"}]],
      "<div a",
      ["=b foo=\"bar>foo\">", [{ type: "StartTag", raw: "<div a=b foo=\"bar>foo\">"}]],
      "<div a",
      ["=b foo='bar>foo'>", [{ type: "StartTag", raw: "<div a=b foo='bar>foo'>"}]],
      "<div a",
      [" / foo=\"bar>foo\">", [{ type: "StartTag", raw: "<div a / foo=\"bar>foo\">"}]],
      ...
      [" / foo='bar>foo'>", [{ type: "StartTag", raw: "<div a / foo='bar>foo'>"}]],
      "<div a",
      [" =foo=\"bar>foo\">", [{ type: "StartTag", raw: "<div a =foo=\"bar>"}, { type: "Text", raw: "foo\">" }]],
      "<div a",
      [" =foo='bar>foo'>", [{ type: "StartTag", raw: "<div a =foo='bar>"}, { type: "Text", raw: "foo'>" }]],
      "<div a",
      ["=b =foo=\"bar>foo\">", [{ type: "StartTag", raw: "<div a=b =foo=\"bar>foo\">"}]],
